...
<head>
	<title>@php echo $config['page_title_text'] ; @endphp</title>
	<meta charset="UTF-8">
	...
	<body class="bg-404">
		<section class="pd-5vw">
			<div class="">
                ...
                @php echo $config['header_text'] ; @endphp
				</div>
                @php echo $config['body_text'] ; @endphp
				
			</div>
			@php echo $config['footer_text'] ; @endphp
			<br>
			<div>
				<a href="{{@$config['mt_twitter_url']}}">Twitter</a> | 
				<a href="{{@$config['mt_facebook_url']}}">Facebook</a>| 
				<a href="{{@$config['mt_instagram_url']}}">Instagram</a>
			</div>
		</section>
        ...
        <div class="row logorow ">
          ...
          <div class="col-sm-8">
            <div class="content_left">
              <h4 class=""> @php echo $config['body_text'] ; @endphp</h4>
