...
<form action="{{route('admin.setting.post')}}" method="post" class="form-ajax" id="Be4MBcHP47k9METK" novalidate="novalidate">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-7">
            ...
            <div class="col-md-5" >
                <div class="form-group row m-3">
                    <label class="col-form-label" for="release"> Payments </label>
                    <input type="hidden" name ="knet_pay" value="0">
                    <input type="hidden" name ="card_pay" value="0">
                    <input type="hidden" name ="cash_pay" value="0">
                    
                    <label class="col-form-label" for="release">
                        <input  name="knet_pay" type="checkbox"  value="1" @if(@$settings['knet_pay']=='1') checked @endif> KNET
                    </label>
                    <label class="col-form-label" for="release">
                        <input  name="card_pay" type="checkbox"  value="1" @if(@$settings['card_pay']=='1') checked @endif> CARD
                    </label>
                    <label class="col-form-label" for="release">
                        <input  name="cash_pay" type="checkbox"  value="1" @if(@$settings['cash_pay']=='1') checked @endif> CASH
                    </label>
                </div>
                  <div class="form-group row m-3">
