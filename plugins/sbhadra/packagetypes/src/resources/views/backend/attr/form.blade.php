        ...
        <div class="col-md-4">
            ...
            <form method="post" action="{{route('admin.package-type-attributes.update', [$model->id])}}" class="form-ajax" data-success="reload_data" id="form-add">
                ...
                <div class="form-group">
                    <label class="control-label mb-10 text-left"><input  type="radio" name="is_theme" value="1" @if($model->is_theme==1) checked @endif /> With Theme</label> 
                    <label class="control-label mb-10 text-left"><input type="radio" name="is_theme" value="0" @if($model->is_theme==0) checked @endif /> No Theme</label> 
                </div>
