            ...
            <h5>{{ trans('juzaweb::app.add_new') }}</h5>
             <form method="post" action="{{route('admin.package-type-attributes.store')}}" class="form-ajax" data-success="reload_data" id="form-add">
                ...
                <div class="form-group">
                    <label class="control-label mb-10 text-left"><input type="radio" name="is_theme" value="1"/> With Theme</label> 
                    <label class="control-label mb-10 text-left"><input type="radio" name="is_theme" value="0"/> No Theme</label> 
                </div>
