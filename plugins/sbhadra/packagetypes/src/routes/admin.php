...
Route::get('/type/order/update', 'PackageTypesController@UpdateOrder')->name('admin.type.update');
Route::get('/attr/order/update', 'PackageTypesAttrController@UpdateOrder')->name('admin.attr.update');
