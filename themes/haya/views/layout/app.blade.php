...
<head>
    ...
    <title>{{ $title }}</title>
    <link href="{{asset('/')}}jw-styles/themes/haya/assets/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

  <!-- Custom fonts for this template -->
  <link href="{{asset('/')}}jw-styles/themes/haya/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
  <link href="{{asset('/')}}jw-styles/themes/haya/assets/vendor/simple-line-icons/css/simple-line-icons.css" rel="stylesheet" type="text/css">
  ...
  @endif
    <!--Owl Carousel CSS-->
  <link rel="stylesheet" href="{{asset('/')}}jw-styles/themes/haya/assets/vendor/owlcarousel/owl.carousel.css">
  <link rel="stylesheet" href="{{asset('/')}}jw-styles/themes/haya/assets/vendor/owlcarousel/owl.theme.default.css">
  <!--Lightbox gallery-->
  <link rel="stylesheet" href="{{asset('/')}}/jw-styles/themes/haya/assets/css/lightbox.min.css">
<!-- Custom styles for this template -->
  <link href="{{asset('/')}}jw-styles/themes/haya/assets/css/landing-page9830.css?y=2" rel="stylesheet">
       <!-- Data table CSS -->
...
<body class="{{ isset($post) ? 'single-post': '' }} {{ body_class() }}">
 ...
 <!-- Bootstrap core JavaScript -->
  <script src="{{asset('/')}}jw-styles/themes/haya/assets/vendor/jquery/jquery.min.js"></script>
  <script src="{{asset('/')}}jw-styles/themes/haya/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="{{asset('/')}}jw-styles/themes/haya/assets/vendor/js/lightbox-plus-jquery.min.js"></script>
