    ...
    <div class="container" style="max-width: 1340px;">
      ...
      <div class="row no-gutters">
                ...
                <div class="card-body p-2">
                  <div class="row align-items-center no-gutters">
                    ...
                    <div class="col-lg-5 col-md-4 order-lg-3 order-md-2 order-sm-1 order-1">
                      <img src="uploads/images/348530-D384831F-FF22-45DF-9702-ED46933AD8CD.jpg" class="img-rounded img-fluid d-block mx-auto mb-md-0 mb-3">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <!-- Package Div End -->
          <!-- Package Div Start -->
           <div class="col-md-6 col-sm-6 col-12">
              <a href="index824f.html?page=reservations&amp;id=8">
              <div class="package-card card m-2">
                <div class="card-body p-2">
                  <div class="row align-items-center no-gutters">
                    ...
                    <div class="col-lg-5 col-md-4 order-lg-3 order-md-2 order-sm-1 order-1">
                      <img src="uploads/images/685686-2D79736A-E864-4F2E-A6B3-884FCFEE3169.jpg" class="img-rounded img-fluid d-block mx-auto mb-md-0 mb-3">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="package-card card m-2">
                <div class="card-body p-2">
                  <div class="row align-items-center no-gutters">
                    ...
                    <div class="col-lg-5 col-md-4 order-lg-3 order-md-2 order-sm-1 order-1">
                      <img src="uploads/images/652757-D5C5240B-7B23-468F-8BD0-288DC990965A.jpg" class="img-rounded img-fluid d-block mx-auto mb-md-0 mb-3">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="package-card card m-2">
                <div class="card-body p-2">
                  <div class="row align-items-center no-gutters">
                    ...
                    <div class="col-lg-5 col-md-4 order-lg-3 order-md-2 order-sm-1 order-1">
                      <img src="uploads/images/881930-F1EBF9F1-4111-4F09-8E92-64781F8A8273.jpg" class="img-rounded img-fluid d-block mx-auto mb-md-0 mb-3">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="package-card card m-2">
                <div class="card-body p-2">
                  <div class="row align-items-center no-gutters">
                    ...
                    <div class="col-lg-5 col-md-4 order-lg-3 order-md-2 order-sm-1 order-1">
                      <img src="uploads/images/385510-EFFF4822-DA46-484E-890B-C227F410DC65.jpg" class="img-rounded img-fluid d-block mx-auto mb-md-0 mb-3">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <!-- Package Div End -->
          <!-- Package Div Start -->
           <div class="col-md-6 col-sm-6 col-12">
              <a href="index0ee6.html?page=reservations&amp;id=15">
              <div class="package-card card m-2">
                <div class="card-body p-2">
                  <div class="row align-items-center no-gutters">
                    ...
                    <h5 class="package-head">Birthday Package Golden</h5>
                      ...
                      <ul class="list-unstyled">
                       ...
                       -->
                      <p class="theme-color package-price-tag text-right"><span>Price:</span><span class="ml-2">120 KD</span></p>
                    </div>
                    <div class="col-lg-5 col-md-4 order-lg-3 order-md-2 order-sm-1 order-1">
                      <img src="uploads/images/939802-82F21494-D76B-483E-BAEF-757FF7CA8F00.jpg" class="img-rounded img-fluid d-block mx-auto mb-md-0 mb-3">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <!-- Package Div End -->
          <!-- Package Div Start -->
           <div class="col-md-6 col-sm-6 col-12">
              <a href="index0265.html?page=reservations&amp;id=16">
              <div class="package-card card m-2">
                <div class="card-body p-2">
                  <div class="row align-items-center no-gutters">
                    ...
                    <h5 class="package-head">Graduation Package</h5>
                      ...
                      <ul class="list-unstyled">
                       ...
                       -->
                      <p class="theme-color package-price-tag text-right"><span>Price:</span><span class="ml-2">80 </span></p>
                    </div>
                    <div class="col-lg-5 col-md-4 order-lg-3 order-md-2 order-sm-1 order-1">
                      <img src="uploads/images/319116-CC647D35-387D-47D7-AC51-8B10266D64D6.jpg" class="img-rounded img-fluid d-block mx-auto mb-md-0 mb-3">
                    </div>
                  </div>
                </div>
              </div>
