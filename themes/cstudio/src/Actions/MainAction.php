...
class MainAction extends Action
{
    ...
    public function addBodyClass()
    {
        $this->addAction('theme.homepackages', function () {
         ...
         $this->addAction('theme.homepackages_haya', function () {
            ...
            if($packages){
                ...
                <div class="row justify-content-center">';
                  ...
                  foreach($packages as $key=>$package){
                        ...
                        $brand_logo = (get_theme_config('brand_logo')?upload_url(get_theme_config('brand_logo')):url('jw-styles/themes/hbqhaya/assets/img/camera.svg'));
                        $html .= '<div class="col-lg-4 px-xl-5 col-sm-6 mb-4">
                                    <div class="pack_item">
                                        <div class="pack_head d-flex align-items-center justify-content-center">
                                            <img src="'.$brand_logo.'" alt="img" class="mw-100">
         ...
         $this->addAction('demah.theme.homepackages', function () {
            $packages = Package::where('status','publish')->orderBy('odrs', 'asc')->get();
            if($packages){
                //var_dump($packages);
                  foreach($packages as $key=>$package){
                    ...
                    if(($key+1) % 2 != 0){
                        ...
                        echo   ' <div class="row py-5 my-5">         
                            ...
                            <div class="col-xxl-4 offset-xxl-1 pe-xxl-5 col-xl-5 d-flex align-items-center">
                                <div class="pack_content position-relative d-flex align-items-center justify-content-center">
                                    <h4 class="position-absolute fs107 CarrinadyB text-primary pe-xl-3">'.($key+1).'</h4>
                                    <div class="pack_info">
                                        <h4 class="fs75 CarrinadyB text-primary text-uppercase mb-xl-5 pb-3 SegoeUIL">
                                        '.$package->title.'
                                        </h4>
                                       
                                        '.str_replace('<ul>',' <ul class="package-list ps-4">',$package->short_description).' 
                                        
                                        <a href="'.$slug .'" class="btn btn-xl btn-primary mt-1 fs24">'.trans('theme::app.book_now').'</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xxl-4 offset-xxl-0 ps-xxl-5 col-xl-5 offset-xl-1 d-flex align-items-center">
                            <div class="pack_content position-relative d-flex align-items-center justify-content-center">
                                <h4 class="position-absolute fs107 CarrinadyB text-primary">'.($key+1).'</h4>
                                <div class="pack_info">
                                    <h4 class="fs75 CarrinadyB text-primary text-uppercase mb-xl-5 pb-3 SegoeUIL">
                                    '.$package->title.'
                                    </h4>
         ...
         $this->addAction('demah.theme.home.about', function() {
