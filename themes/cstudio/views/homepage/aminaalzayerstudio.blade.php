        ...
        <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 px-0">
                        <img src="{{asset('/')}}jw-styles/themes/hbqhaya/assets/img/hero_banner203.jpg" alt="img" class="w-100">
                    </div>
                    <div class="col-lg-6 px-0">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 d-flex justify-content-center align-items-center py-4">
                        <img src="{{asset('/')}}jw-styles/themes/hbqhaya/assets/img/logo-ts2.png" alt="img" class="mw-100">
                    </div>
                </div>
            </div>
        </section>
