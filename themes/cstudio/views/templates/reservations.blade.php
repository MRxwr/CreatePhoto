                                        ...
                                        <!-- data-bs-toggle="modal" data-bs-target="#exampleModal" -->
                                         <div class="d-flex mb-3"> 
                                          ...
                                          <div class="d-flex mb-3"> 
                                             ...
                                             <?php if($config['knet_pay']==1) { ?>
                                                <label>
                                                <input type="radio" id="payment_method1" name="payment_method" value="knet" checked style="width:24px; height:24px;margin:5px;"><span class="fs24">Knet Only </span>
                                                <label/>
                                            <?php }?>
                                            <?php if($config['card_pay']==1) { ?>
                                                <label>
                                                <input type="radio" id="payment_method2" name="payment_method" value="card" checked style="width:24px; height:24px;margin:5px;"><span class="fs24"> Card Only </span>
                                                <label/>
                                             <?php }?>
                                             <?php if($config['cash_pay']==1) { ?>
                                                <label>
                                                <input type="radio" id="payment_method3" name="payment_method" value="cash" checked style="width:24px; height:24px;margin:5px;"><span class="fs24"> Cash Only </span>
                                                <label/>
                                             <?php } ?>
